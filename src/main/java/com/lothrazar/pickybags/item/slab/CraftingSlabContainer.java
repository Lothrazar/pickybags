...
public class CraftingSlabContainer extends ContainerFlib {
  ...
  public CraftingSlabContainer(int id, Inventory playerInventory, Player player, int slot) {
    super(BagsMenuRegistry.SLAB.get(), id);
