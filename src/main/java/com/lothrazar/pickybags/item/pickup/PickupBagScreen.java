...
public class PickupBagScreen extends AbstractContainerScreen<PickupBagContainer> {

  public PickupBagScreen(PickupBagContainer screenContainer, Inventory inv, Component titleIn) {
  ...
  public void extractBackground(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
    ...
    this.drawBackground(graphics, BagsMenuRegistry.SHULKER);
  }
